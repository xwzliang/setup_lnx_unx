...
apps_other_methods=(
    ...
    ["nvm"]="curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.35.3/install.sh | bash"		# Node Version Manager
    ...
    ["cask"]="curl -fsSL https://raw.githubusercontent.com/cask/cask/master/go | python"             # Project management tool for Emacs
    ["docker-machine"]="curl -L https://github.com/docker/machine/releases/download/v$(lastversion docker/machine)/docker-machine-`uname -s`-`uname -m` >/tmp/docker-machine &&
    ...
    ["sdk"]="curl -s https://get.sdkman.io | bash"					# SDKMAN! is a tool for managing parallel versions of multiple Software Development Kits on most Unix based systems
